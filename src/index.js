...
exports.default = getWebSocketClient;
...
var b64u = exports.b64u = function b64u(str) {
...
exports.ChatComponent = exports.messageReducer = undefined;
...
var _ChatContainer = __webpack_require__(74);
...
var _generation = __webpack_require__(15);

var _messages2 = __webpack_require__(21);
...
var messageReducer = exports.messageReducer = _messages3.default;

var ChatComponent = exports.ChatComponent = function ChatComponent(_ref) {
    var url = _ref.url,
        config = _ref.config,
    ...
    var add = function add(message) {
        return store.dispatch((0, _messages.messageAdd)(message));
    };
    (0, _client2.default)(url, config, add);
    return useProvider ? _react2.default.createElement(
...
var ReactChatUI = function ReactChatUI() {
    var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
        ...
        sessionID: _generation.randomId,
    ...
    if (element && element.nodeName && workflowID) {
        ...
        console.error(workflowID ? 'React Chat UI: expected element to be a DOM element, instead got: ' + element : 'React Chat UI: No workflowID provided.');
    }
};

exports.default = ReactChatUI;
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var invariant=__webpack_require__(3);var React=__webpack_require__(1);var warning=__webpack_require__(11);var ExecutionEnvironment=__webpack_require__(23);var _assign=__webpack_require__(10);var emptyFunction=__webpack_require__(4);var checkPropTypes=__webpack_require__(28);var getActiveElement=__webpack_require__(24);var shallowEqual=__webpack_require__(25);var containsNode=__webpack_require__(26);var emptyObject=__webpack_require__(27);var hyphenateStyleName=__webpack_require__(57);var camelizeStyleName=__webpack_require__(59);// Relying on the `invariant()` implementation lets us
...
var _InputBar = __webpack_require__(87);
    ...
    _createClass(ChatContainer, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                showInput && _react2.default.createElement(_InputBar2.default, null),
...
var _CSSTransitionGroupChild = __webpack_require__(81);
...
var _chainFunction = __webpack_require__(78);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
    return {
        onSubmit: function onSubmit(message) {
            return dispatch((0, _messages.messageAdd)(message));
        }
    };
};
    ...
    _createClass(InputBar, [{
        ...
        value: function handleOnKeyDown(event) {
            ...
            if (event.which === 13) {
                ...
                (0, _client2.default)().send(JSON.stringify(message));
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(InputBar);
...
var MessageContainer = function MessageContainer(_ref) {
    var modifiers = _ref.modifiers,
        ...
        rest = _objectWithoutProperties(_ref, ['modifiers', 'origin', 'text', 'buttons', 'lastMessage']);
    ...
    return _react2.default.createElement(
        ...
        buttons && lastMessage ? _react2.default.createElement(
            'div',
            { className: 'ButtonContainer' },
            buttons.map(function (button) {
                var id = (0, _generation.randomId)();
                return _react2.default.createElement(
                    _Button2.default,
                    {
                        key: id,
...
var Button = function (_Component) {
    ...
    _createClass(Button, [{
        ...
        value: function handleClick(event) {
            ...
            (0, _client2.default)().send(JSON.stringify(button));
